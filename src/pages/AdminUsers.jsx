    ...
    <div className="min-h-screen w-full bg-background text-white p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex justify-between items-end border-b border-white/10 pb-6">
          ...
          <div className="bg-white/[0.03] border border-white/10 px-5 py-3 rounded-lg flex items-center gap-3">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-white/5">
               {users.length === 0 ? (
                ...
                users.map(u => (
                  <tr key={u._id} className={`hover:bg-white/[0.02] transition-colors ${u.status === 'rejected' ? 'opacity-40 grayscale pointer-events-none hover:bg-transparent' : ''}`}>
                    <td className="p-5">
